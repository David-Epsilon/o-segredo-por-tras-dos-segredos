      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="order-2 lg:order-1 relative">
            ...
            {/* Floating stats box */}
            <div className="absolute -bottom-6 -right-6 md:right-10 bg-slate-900 border border-amber-500/40 p-6 rounded-2xl shadow-2xl max-w-xs">
              <div className="text-amber-500 text-3xl font-bold mb-1">317 Páginas</div>
              <p className="text-slate-400 text-sm">De puro conhecimento transformador unindo física quântica e tradições herméticas.</p>
            </div>
          </div>

          <div className="order-1 lg:order-2 space-y-8">
            <h2 className="font-cinzel text-3xl md:text-5xl font-bold leading-tight">
              A Chave Oculta: <span className="text-amber-500">O Diamagnetismo</span>
            </h2>
            <div className="space-y-6 text-slate-300 text-lg font-light">
              ...
              <div className="flex items-start space-x-4 bg-slate-900/50 p-6 rounded-xl border-l-4 border-amber-500">
                ...
                <div>
                  <h4 className="font-bold text-white mb-2">Descoberta Científica</h4>
                  <p className="text-sm">Por que o sangue humano possui propriedades diamagnéticas únicas e como seus pensamentos modulam esse campo.</p>
                </div>
              </div>
              <p>
                Este não é apenas mais um livro de autoajuda. É um mapa detalhado para você compreender o seu campo energético e usá-lo para transformar sua existência.
              </p>
            </div>
            <a 
              href="#checkout" 
