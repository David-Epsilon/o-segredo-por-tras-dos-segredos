...
const FAQ: React.FC = () => {
  const faqs = [
    { question: "Este livro é baseado em qual religião?", answer: "Nenhuma. Ele integra sabedoria universal de múltiplas tradições (cristianismo, budismo, hermetismo) com ciência moderna (física quântica). É um estudo sobre consciência e energia." },
    { question: "Preciso ter conhecimento prévio em física ou espiritualidade?", answer: "Não. O livro é escrito de forma acessível, explicando cada conceito passo a passo, do básico ao avançado." },
    ...
    { question: "As práticas descritas são seguras?", answer: "Sim. Todas as práticas são baseadas em tradições milenares e princípios biofísicos seguros. O autor orienta sobre os cuidados necessários em cada técnica." },
